def desenha_losango(altura, caractere='#'):
    ...
    if altura % 2 == 0: # divisao da altura por 2 com resto zero == par
        ...
        print(f'O valor digitado era par, usaremos {altura} no lugar')
    ...
    for linha_atual in range(altura):
        ...
        if linha_atual <= meio: # se a linha for menor ou igual ao meio
            ...
            num_caracteres = linha_atual * 2 + 1 # cria uma variavel que recebe o que vai ser produzido
            ...
            num_caracteres = altura - (linha_atual - meio) * 2

        print(' ' * num_espacos + caractere * num_caracteres)
